        ...
        <div>
                    <div className="degree4">
                            ...
                            <div>
                                ...
                                <p>Achieving milestones for immediate growth.</p>
                                <Link>in Short/Long Term </Link>    

                                <p className="this-paragraph">The attainment of crucial milestones marks a pivotal juncture for immediate growth strategies. These achievements signal a readiness to expand operations and capitalize on new opportunities. With these milestones in place, the company is positioned to embark on a trajectory of accelerated growth and development.</p>
                                ...
                                <div>
                                     ...
                                     <div>
                                        <div>
                                            <p><Link to="/ShortLong" className="btn1"> <FaBell size={15} style={{color: "#000", marginRight: "1px"}}/> Follow Category</Link></p>
