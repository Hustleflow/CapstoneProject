        ...
        <div>
                    <div className="degree4">
                            ...
                            <div>
                                ...
                                <p>Annual physical examination required for all.</p>
                                <Link>in EmployeeHealth </Link>    

                                <p className="this-paragraph">All employees are required to undergo an annual physical examination as part of company policy. This practice underscores the organization's commitment to employee well-being and health awareness. By ensuring regular check-ups, the company aims to prioritize the long-term health and productivity of its workforce.</p>
                                ...
                                <div>
                                     ...
                                     <div>
                                        <div>
                                            <p><Link to="/EmployeeHealth" className="btn1"> <FaBell size={15} style={{color: "#000", marginRight: "1px"}}/> Follow Category</Link></p>
