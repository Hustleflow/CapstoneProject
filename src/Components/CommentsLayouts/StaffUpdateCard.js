    ...
    return (
        ...
        <div>
                    <div className="degree">
                            <h4 className="h4style">STAFF UPDATES | Sort by: <button>Recent Activity</button></h4>
        ...
        <div>
            ...
            <div className="degree">
                    <p className="thisparagraph">What's the latest team progress?<FaThumbtack size={20} style={{color: "transparent", marginRight: "1px"}}/></p>
            ...
            <div>
                <div className="degree">
                     ...
                     <div>
                <div className="degree">
                        <p className="h4style"><Link to="/Topic" className="link-nostyle">Are challenges being addressed?</Link><FaThumbtack size={20} style={{color: "transparent", marginRight: "1px"}}/></p>
            ...
            <div className="degree">
                        <p className="h4style"><Link to="/Topic" className="link-nostyle">Some ways for all to collaborate?</Link><FaThumbtack size={20} style={{color: "transparent", marginRight: "1px"}}/></p>
