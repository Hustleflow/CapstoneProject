    ...
    return (
        ...
        <div>
                    <div className="degree">
                            <h4 className="h4style">LOGISTICS | Sort by: <button>Recent Activity</button></h4>
        ...
        <div>
            ...
            <div className="degree">
                    <p className="thisparagraph">How has our logistics evolved?<FaThumbtack size={20} style={{color: "transparent", marginRight: "1px"}}/></p>
            ...
            <div>
                <div className="degree">
                        <p className="h4style"><Link to="/Topic" className="link-nostyle">How has our logistics evolved?</Link><FaThumbtack size={20} style={{color: "#000", marginRight: "1px"}}/></p>
            ...
            <div>
                <div className="degree">
                        <p className="h4style"><Link to="/Topic" className="link-nostyle">How are the logistics planned?</Link><FaThumbtack size={20} style={{color: "transparent", marginRight: "1px"}}/></p>
                     ...
                     <div>
                <div className="degree">
                        <p className="h4style"><Link to="/Topic" className="link-nostyle">How has our logistics evolved?</Link><FaThumbtack size={20} style={{color: "transparent", marginRight: "1px"}}/></p>
